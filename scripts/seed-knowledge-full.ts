...
IMPORTANTE: Se o cliente NÃO mora em nenhuma dessas cidades, a Sulma deve informar com empatia que por enquanto o atendimento presencial (exames e consultas) está disponível apenas nessas regiões.`,
...
- Sulma recomenda plano ideal
- Score esperado: 400-600

DIA 3-5 — Negociação
- Lead avalia, faz perguntas finais
- Sulma responde objeções com naturalidade
- Pode enviar card do plano recomendado
- Score esperado: 600-800

DIA 5-7 — Fechamento
- Lead decide assinar
- Sulma transfere para humano ou envia link de checkout
- Score esperado: 800+
...
IMPORTANTE: Essa timeline é um guia. Alguns leads fecham no dia 1, outros levam semanas. O importante é não forçar — deixar o lead avançar no seu ritmo.`,
  ...
  },
  {
    ...
    content: `Objeções comuns e como a Sulma deve responder:
...
→ Verificar na base de conhecimento (cidades atendidas). Se não tiver a cidade, oferecer verificar com a equipe.`,
  ...
  {
    category: "lead_ideal",
    title: "Regras de Ouro da Sulma — Vendas Consultivas",
    content: `Regras que a Sulma DEVE seguir sempre:
...
Frases que a Sulma NUNCA deve usar:
